...
const submit = () => {
    form.post(route("wave.store"));
};
const update = () => {
    form.put(route("wave.update", props.phone?.id));
};

const deleteForm = (id) => {
    form.delete(route("wave.destroy", id));
};
</script>

<template>
    <AppLayout title="Configurer mon compte wave">
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Configuration De Compte Wave
            </h2>
        </template>
        <div class="py-4">
            <div class="max-w-9xl mx-auto sm:px-6 lg:px-14">
                ...
                <div class="max-w-4xl mx-auto gap-12 w-full p-4">
                    ...
                    <section class="space-y-6">
                        ...
                        >
                            <InputLabel for="phone" value="Votre numéro wave" />
